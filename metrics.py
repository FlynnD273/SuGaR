...
os.makedirs(os.path.join("lpipsPyTorch", "weights"), exist_ok=True)
torch.hub.set_dir(os.path.join("lpipsPyTorch", "weights"))
...
if __name__ == "__main__":
    ...
    result_file_dir = os.path.join("output", "metrics")
                ...
                for decimation_target in decimation_targets:
                    for refinement_iterations in refinement_iterations_list:
                        ...
                        if use_uv_texture:
                            ...
                            refined_sugar_path = os.path.join(path.join("output", "refined", scene_name, refined_sugar_path)
